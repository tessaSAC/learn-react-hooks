...
#### What I learned:
Learn how to use useState to idempotently update multiple state values at once. Got a bit lost in the Q&A, maybe since I don't have any work problems around this right now that I can relate to. Would like to know more about when to use this solution vs what we did in the advanced workshop today.

#### General comments:
Not really sure when or why I'd want to use this.