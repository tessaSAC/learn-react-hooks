...
#### What I learned:
Learned how to use hooks and state updater functions. Still unclear on the magic argument the SUF receives though.

#### General comments:
Not sure, except for the egghead course yesterday I haven't used React in 2y so I was mostly reading and applying the docs.
